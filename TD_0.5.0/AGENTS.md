...
2026-08-28 after Normal's extension to forty waves**, through
`node tools/ci-check.js`, which is the gate and holds these same numbers as its
baseline:

```
node tests/run.js                 175 pass / 0 fail   core game, schedules, difficulty
node tests/content.test.js        282 pass / 0 fail   content, visuals and index
