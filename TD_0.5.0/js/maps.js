...
Maps.ENVIRONMENTS = {
  ...
  "ironwood-frontier": {
    ...
    models: [
      ...
      // top out around two degrees: just clear of the treeline, with sky above
      // them, which is the only arrangement in which a horizon exists at all.
      { kind: "ridge", x: -3320, y: -3392, size: 491, rotation: 0.36 },
      { kind: "ridge", x: -2504, y: -3586, size: 431, rotation: 2.81 },
      { kind: "ridge", x: -1367, y: -3601, size: 390, rotation: 0.22 },
      { kind: "ridge", x: -627, y: -3461, size: 468, rotation: 3.24 },
      { kind: "ridge", x: 738, y: -3515, size: 482, rotation: 0.91 },
      { kind: "ridge", x: 1869, y: -3509, size: 437, rotation: 2.86 },
      { kind: "ridge", x: 2264, y: -3519, size: 597, rotation: 2.16 },
      { kind: "ridge", x: 3491, y: -3510, size: 397, rotation: 1.30 },
      { kind: "ridge", x: 4316, y: -3503, size: 484, rotation: 1.76 },
      { kind: "ridge", x: 4731, y: -3226, size: 521, rotation: 3.31 },
      { kind: "ridge", x: 4921, y: -2196, size: 490, rotation: 4.61 },
      { kind: "ridge", x: 4742, y: -1846, size: 568, rotation: 1.36 },
      { kind: "ridge", x: 4744, y: -714, size: 446, rotation: 1.70 },
      { kind: "ridge", x: 4712, y: 66, size: 535, rotation: 1.74 },
      { kind: "ridge", x: 4681, y: 1059, size: 452, rotation: 5.93 },
      { kind: "ridge", x: 4781, y: 1998, size: 497, rotation: 3.88 },
      { kind: "ridge", x: 4891, y: 3259, size: 580, rotation: 2.46 },
      { kind: "ridge", x: 4897, y: 3824, size: 519, rotation: 2.42 },
      { kind: "ridge", x: 4355, y: 4199, size: 521, rotation: 1.07 },
      { kind: "ridge", x: 3852, y: 4355, size: 602, rotation: 3.28 },
      { kind: "ridge", x: 2376, y: 4185, size: 566, rotation: 4.35 },
      { kind: "ridge", x: 1951, y: 4159, size: 543, rotation: 4.03 },
      { kind: "ridge", x: 961, y: 4179, size: 562, rotation: 3.53 },
      { kind: "ridge", x: 52, y: 4252, size: 446, rotation: 5.13 },
      { kind: "ridge", x: -700, y: 4241, size: 438, rotation: 4.45 },
      { kind: "ridge", x: -1747, y: 4177, size: 511, rotation: 2.31 },
      { kind: "ridge", x: -2541, y: 4275, size: 396, rotation: 0.75 },
      { kind: "ridge", x: -3333, y: 4219, size: 602, rotation: 1.65 },
      { kind: "ridge", x: -3582, y: 3061, size: 456, rotation: 3.35 },
      { kind: "ridge", x: -3617, y: 2198, size: 430, rotation: 1.25 },
      { kind: "ridge", x: -3515, y: 1606, size: 395, rotation: 5.96 },
      { kind: "ridge", x: -3455, y: 67, size: 586, rotation: 6.16 },
      { kind: "ridge", x: -3575, y: -78, size: 472, rotation: 1.65 },
      { kind: "ridge", x: -3464, y: -1329, size: 402, rotation: 1.67 },
      { kind: "ridge", x: -3487, y: -1960, size: 588, rotation: 5.69 },
      { kind: "ridge", x: -3588, y: -3101, size: 421, rotation: 1.91 },
      { kind: "ridge", x: -3604, y: -4246, size: 654, rotation: 1.56 },
      { kind: "ridge", x: -1991, y: -4214, size: 529, rotation: 4.39 },
      { kind: "ridge", x: -1380, y: -4170, size: 632, rotation: 3.80 },
      { kind: "ridge", x: -248, y: -3969, size: 726, rotation: 1.16 },
      { kind: "ridge", x: 581, y: -4020, size: 586, rotation: 2.56 },
      { kind: "ridge", x: 1892, y: -4202, size: 571, rotation: 3.09 },
      { kind: "ridge", x: 3154, y: -4234, size: 550, rotation: 4.84 },
      { kind: "ridge", x: 4366, y: -4283, size: 660, rotation: 1.49 },
      { kind: "ridge", x: 5535, y: -3895, size: 765, rotation: 4.58 },
      { kind: "ridge", x: 5420, y: -2340, size: 612, rotation: 3.71 },
      { kind: "ridge", x: 5286, y: -1207, size: 499, rotation: 0.81 },
      { kind: "ridge", x: 5557, y: -507, size: 568, rotation: 4.25 },
      { kind: "ridge", x: 5581, y: 869, size: 747, rotation: 5.72 },
      { kind: "ridge", x: 5398, y: 1673, size: 585, rotation: 3.69 },
      { kind: "ridge", x: 5352, y: 2819, size: 659, rotation: 4.02 },
      { kind: "ridge", x: 5312, y: 4367, size: 701, rotation: 3.93 },
      { kind: "ridge", x: 4901, y: 4874, size: 633, rotation: 3.89 },
      { kind: "ridge", x: 3557, y: 4930, size: 596, rotation: 5.48 },
      { kind: "ridge", x: 2458, y: 4895, size: 657, rotation: 2.63 },
      { kind: "ridge", x: 861, y: 4736, size: 669, rotation: 4.15 },
      { kind: "ridge", x: 425, y: 4726, size: 645, rotation: 1.22 },
      { kind: "ridge", x: -679, y: 4994, size: 680, rotation: 0.33 },
      { kind: "ridge", x: -1728, y: 4933, size: 666, rotation: 3.82 },
      { kind: "ridge", x: -3370, y: 4802, size: 568, rotation: 5.81 },
      { kind: "ridge", x: -4273, y: 4649, size: 654, rotation: 4.50 },
      { kind: "ridge", x: -4225, y: 3518, size: 515, rotation: 4.65 },
      { kind: "ridge", x: -3978, y: 1847, size: 615, rotation: 4.09 },
      { kind: "ridge", x: -3985, y: 977, size: 529, rotation: 3.82 },
      { kind: "ridge", x: -4032, y: 330, size: 610, rotation: 2.89 },
      { kind: "ridge", x: -4092, y: -1279, size: 656, rotation: 4.56 },
      { kind: "ridge", x: -4069, y: -2794, size: 590, rotation: 5.80 },
      { kind: "ridge", x: -4009, y: -3379, size: 531, rotation: 5.01 },
